...
func init() {
	...
	gomniauth.WithProviders(
		google.New("263031405003-9h711redm85cj3cgcvq6dgnq9lmbogig.apps.googleusercontent.com",
			"7g43W2Wlx9lJdkWZPlWiB1be",
			"http://49.247.211.93:8080/auth/callback/google"),
	)
}
